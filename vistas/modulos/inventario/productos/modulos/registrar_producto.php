                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-3 mb-2">
                                            ...
                                            <input type="number" min="0" step="0.01" value="0.00" placeholder="Ingrese stock mínimo" class="form-control form-control-sm" id="minimo_stock" name="minimo_stock" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                        </div>

                                        <!-- COSTO UNITARIO -->
                                        <div class="col-12 col-lg-3 mb-2">
                                            <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-dollar-sign mr-1 my-text-color"></i>Costo Unitario</label>
                                            <input type="number" min="0" step="0.01" value="0.00" placeholder="Ingrese costo" class="form-control form-control-sm" id="costo_unitario" name="costo_unitario" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                        </div>

                                        <!-- STOCK INICIAL -->
                                        <div class="col-12 col-lg-3 mb-2">
                                            <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-boxes mr-1 my-text-color"></i>Stock Inicial</label>
                                            <input type="number" min="0" step="0.01" value="0.00" placeholder="Ingrese stock inicial" class="form-control form-control-sm" id="stock_inicial" name="stock_inicial" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                        </div>

                                        <!-- ALMACEN -->
                                        <div class="col-12 col-lg-3 mb-2">
                                            <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-warehouse mr-1 my-text-color"></i>Almacén Inicial</label>
                                            <select class="form-select form-select-sm select2 cursor-pointer" id="id_almacen" name="id_almacen" aria-label="Floating label select example" required>
                                            </select>
...
<script>
    ...
    function fnc_cargarSelectCategorias() {
        ...
        CargarSelect(1, $("#id_almacen"), "--Seleccione un Almacén--", "ajax/almacenes.ajax.php", 'obtener_almacenes');
    }
