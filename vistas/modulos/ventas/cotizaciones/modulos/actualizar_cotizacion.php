...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2 class="m-0 fw-bold">ACTUALIZAR COTIZACIÓN NRO: <?php echo $id_cotizacion ?></h2>
            </div><!-- /.col -->
...
<script>
    ...
    function CargarSelects() {
        ...
        $("#tipo_comprobante_a_generar option[value='NC']").remove();
        $("#tipo_comprobante_a_generar option[value='31']").remove();
