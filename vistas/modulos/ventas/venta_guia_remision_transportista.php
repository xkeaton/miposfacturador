...
<div class="content-header pb-1">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2 class="m-0 fw-bold">GUÍA DE REMISIÓN TRANSPORTISTA</h2>
            </div><!-- /.col -->
        ...
        <div class="col-12 ">
            ...
            <div class="card card-primary card-outline card-outline-tabs">
                ...
                <div class="card-body py-1">
                    ...
                    <form id="frm-datos-guia-remision-transportista" class="needs-validation-guia-remision-transportista" novalidate>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body py-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-3 mb-2">
                                                ...
                                                <div class="input-group input-group-sm mb-3 ">
                                                    <span class="input-group-text " id="inputGroup-sizing-sm" style="cursor: pointer;"><i class="fas fa-search ml-1 text-white"></i></span>
                                                    <input type="text" class="form-control form-control-sm" style="border-top-right-radius: 20px;border-bottom-right-radius: 20px;" aria-label="Sizing example input" id="nro_documento_chofer" name="nro_documento_chofer" placeholder="Ingrese Nro de documento" aria-describedby="inputGroup-sizing-sm">
                                                </div>
                                            ...
                                            <div class="col-12 col-lg-3 mb-2">
                                                <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-map-marker-alt mr-1 my-text-color"></i>Apellidos Chofer <strong class="text-danger">*</strong></label>
                                            ...
                                            <div class="col-12 col-lg-3 mb-2">
                                                ...
                                                <input type="text" style="border-radius: 20px;" class="form-control form-control-sm text-uppercase" id="licencia_chofer" name="licencia_chofer" placeholder="Ingrese licencia " aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                            </div>

                                            <div class="col-12 col-lg-3 mb-2">
                                                <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-map-marker-alt mr-1 my-text-color"></i>Placa Vehículo <strong class="text-danger">*</strong></label>
                                                <input type="text" style="border-radius: 20px;" class="form-control form-control-sm text-uppercase" id="placa_vehiculo" name="placa_vehiculo" placeholder="Ingrese la placa" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card card-gray shadow">
                                    <div class="card-header">
                                        <h3 class="card-title fs-6">DATOS DEL DESTINATARIO</h3>
                                        <div class="card-tools m-0">
                                            <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                                <i class="fas fa-minus"></i>
                                            </button>
                                    ...
                                    <div class="card-body py-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-3 mb-2">
                                                ...
                                                <select class="form-select" id="tipo_documento_destinatario" name="tipo_documento_destinatario" aria-label="Floating label select example" required>
                                                </select>
                                            ...
                                            <div class="col-12 col-lg-3 mb-2">
                                                ...
                                                <div class="input-group input-group-sm mb-3 ">
                                                    <span class="input-group-text" id="inputGroup-sizing-sm" style="cursor: pointer;"><i class="fas fa-search ml-1 text-white"></i></span>
                                                    <input type="text" class="form-control form-control-sm" style="border-top-right-radius: 20px;border-bottom-right-radius: 20px;" aria-label="Sizing example input" id="nro_documento_destinatario" name="nro_documento_destinatario" placeholder="Ingrese Nro de documento" aria-describedby="inputGroup-sizing-sm" required />
                                            ...
                                            <div class="col-12 col-lg-6 mb-2">
                                                <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-user-tie mr-1 my-text-color"></i>Nombres y Apellidos<strong class="text-danger">*</strong></label>
                                                <input type="text" style="border-radius: 20px;" class="form-control form-control-sm" id="nombre_destinatario" name="nombre_destinatario" placeholder="Ingrese Nombre del Transportista" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required />
                                                <div class="invalid-feedback">Ingrese el Nro de Documento</div>
                                            </div>
                                    ...
                                    <div class="card-body py-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-5 mb-2">
                                                ...
                                                <input type="text" placeholder="Ingrese el ubigeo de partida" style="border-radius: 20px;" class="form-control form-control-sm" id="ubigeo_partida" name="ubigeo_partida" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                            ...
                                            <div class="col-12 col-lg-4 mb-2">
                                                ...
                                                <input type="text" style="border-radius: 20px;" class="form-control form-control-sm" id="direccion_partida" name="direccion_partida" placeholder="Ingrese la dirección de partida" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                                <div class="invalid-feedback">Ingrese Dirección Partida</div>
                                            </div>

                                            <!-- CODIGO ESTABLECIMIENTO SUNAT -->
                                            <div class="col-12 col-lg-3 mb-2">
                                                <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-phone-alt mr-1 my-text-color"></i>Código Establ. Sunat <sub class="text-success">(opcional)</sub></label>
                                    ...
                                    <div class="card-body py-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-5 mb-2">
                                                ...
                                                <input type="text" placeholder="Ingrese el ubigeo de llegada" style="border-radius: 20px;" class="form-control form-control-sm" id="ubigeo_llegada" name="ubigeo_llegada" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                            ...
                                            <div class="col-12 col-lg-4 mb-2">
                                                <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-map-marker-alt mr-1 my-text-color"></i>Dirección <strong class="text-danger">*</strong></label>
                                                <input type="text" style="border-radius: 20px;" class="form-control form-control-sm" id="direccion_llegada" name="direccion_llegada" placeholder="Ingrese la dirección de llegada" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
                                                <div class="invalid-feedback">Ingrese Punto Llegada</div>
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btnGuardarGuiaRemision").on("click", function() {
            fnc_GenerarGuiaRemisionTransportista();
        })
        ...
        $('#tbl_ListadoChoferes tbody').on('click', '.btnEliminarChofer', function() {
            // alert("entro")
            $('#tbl_ListadoChoferes').DataTable().row($(this).parents('tr')).remove().draw();
        })
    ...
    function fnc_LimpiarControles() {
        ...
        $(".needs-validation-guia-remision-transportista").removeClass("was-validated");
    ...
    function fnc_CargarSelects() {
        ...
        CargarSelect('31', $("#tipo_comprobante"), "--Seleccionar--", "ajax/series.ajax.php", 'obtener_tipo_comprobante');
        ...
        CargarSelect(null, $("#tipo_documento_destinatario"), "--Seleccionar--", "ajax/ventas.ajax.php", 'obtener_tipo_documento');
        ...
        $('#tipo_documento_chofer option[value=""]').remove();
        $('#tipo_documento_chofer option[value="0"]').remove();
        $('#tipo_documento_chofer option[value="4"]').remove();
        $('#tipo_documento_chofer option[value="6"]').remove();
        $('#tipo_documento_chofer option[value="7"]').remove();
    ...
    function fnc_CargarAutocompleteClientes() {
        ...
        $("#cliente").autocomplete({
            source: "ajax/autocomplete_clientes_guias.ajax.php",
            minLength: 2,
            autoFocus: true,
    ...
    function fnc_AgregarChofer() {
        ...
        $('#tbl_ListadoChoferes').DataTable().row.add({
            ...
            'tipo_documento': $("#tipo_documento_chofer option:selected").text().toUpperCase(),
    ...
    function fnc_GenerarGuiaRemisionTransportista() {


        let count = 0;
        form_guia_remision_validate = validarFormulario('needs-validation-guia-remision-transportista');
        ...
        Swal.fire({
            title: 'Está seguro(a) de generar la Guía de Remisión Transportista?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                var formData = new FormData();
                formData.append('accion', 'generar_guia_remision_transportista');
                formData.append('datos_guia_remision_transportista', $("#frm-datos-guia-remision-transportista").serialize());
                ...
                if (response.sunatResponse.success) {
                    Swal.fire({
                        position: 'top-center',
                        icon: 'success',
                        title: response.sunatResponse.cdrResponse.description + ', se generó la Guia de Remisión Transportista: ' + response.guia,
    ...
    //GENERALES
    /*===================================================================*/
    function fnc_ConsultarNroDocumentoChofer(nro_documento) {
        ...
        if (response) {
            ...
            if ($("#tipo_documento_chofer").val() == 1) {
                $("#nombres_chofer").val(response['nombres']);
                $("#apellidos_chofer").val(response['apellidos'] + ' ' + response['apellidoMaterno']);
            } else if ($("#tipo_documento_chofer").val() == 6) {
                $("#nombres_chofer").val(response['razonSocial']);
            }

        }
    }

    function fnc_ConsultarNroDocumentoDestinatario(nro_documento) {
        ...
        if (response) {
            ...
            if ($("#tipo_documento_destinatario").val() == 1) {
                $("#nombre_destinatario").val(response['nombres'] + ' ' + response['apellidoPaterno'] + ' ' + response['apellidoMaterno']);
            } else if ($("#tipo_documento_destinatario").val() == 6) {
                $("#nombre_destinatario").val(response['razonSocial']);
            }
