    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-12" style="border: 1px solid #17202a;">
        ...
        $("#btnGuardarCierreCaja").on('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let cleanValue = (selector) => {
                        let htmlVal = $(selector).html() || '0.00';
                        return htmlVal.replace(/[^0-9.-]+/g, '');
                    };
                    
                    formData.append('ingresos', cleanValue("#importe_ingresos"));
                    formData.append('devoluciones', cleanValue("#importe_devoluciones"));
                    formData.append('gastos', cleanValue("#importe_gastos"));
                    formData.append('monto_final', cleanValue("#importe_monto_apertura_saldo_total"));
